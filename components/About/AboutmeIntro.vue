<template>
  <div
    class="h-auto flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16 md:pt-16 pt:2 md:container mx-auto px-8 py-8"
  >
    <div class="flex flex-col">
      <div class="flex flex-col">
        ...
        >
          With over 2 years of dedicated focus on web developer that achieve
          business goals, I have established myself as a trusted professional in
          the industry.
        </p>
      </div>

      <div class="flex flex-wrap w-full pt-[12px] pl-[40px]">
        <div class="flex-1 flex flex-col items-start text-left">
          <h1 class="font-[700] text-[50px] text-white">2+</h1>
          <p
            class="text-[16px] bg-[linear-gradient(#fff,_#696969)] bg-clip-text text-transparent"
          >
            Years Of Experience
          </p>
        </div>
        <div class="flex-1 flex flex-col items-start text-left">
          <h1 class="font-[700] text-[50px] text-white">20+</h1>
          <p
            class="text-[16px] bg-[linear-gradient(#fff,_#696969)] bg-clip-text text-transparent"
          >
            Completed Projects
        ...
        <div class="flex-1 flex flex-col items-start text-left">
          <h1 class="font-[700] text-[50px] text-white">10+</h1>
          <p
            class="text-[16px] bg-[linear-gradient(#fff,_#696969)] bg-clip-text text-transparent"
          >
            Technologies Used
        ...
        <div class="flex-1 flex flex-col items-start text-left">
          <h1 class="font-[700] text-[50px] text-white">90%+</h1>
          <p
            class="text-[16px] bg-[linear-gradient(#fff,_#696969)] bg-clip-text text-transparent"
          >
